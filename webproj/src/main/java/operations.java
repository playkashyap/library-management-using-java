...
public class operations extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    out.println("<head><title>Library</title>");
	    ...
	    out.println("<a class=\"navbar-brand\" href=\"#!\">Library</a>");
	    ...
	    out.println("<li class=\"nav-item\"><a class=\"nav-link active\" href=\"http://localhost:8080/webproj/operations\">Crud</a></li>");
	    out.println("<li class=\"nav-item\"><a class=\"nav-link\" href=\"http://localhost:8080/webproj/crud\">Data available</a></li>");
	    out.println("</ul>");
	    out.println("</div>");
	    out.println("</div>");
	    out.println("</nav>");
	    ...
	    out.println("<h1>Total books Available</h1>");
	    out.println("</div>\n");
		...
		out.println("<a class=\"btn btn-dark\" href=\"addbooks.html\" role=\"button\">Add books</a>");
		out.println("<a class=\"btn btn-dark\" href=\"delete.html\" role=\"button\">Deleat books</a>");
		out.println("<a class=\"btn btn-dark\" href=\"update.html\" role=\"button\">Update books</a>");
		out.println("</div>");
		out.println("</div>");
		out.println("</div>");
		out.println("</div>");
